...
#### [1531. 484. ]
> press Representations ............................. 6 Filed `SEC` Documents ................................. 4 Fundamental R

#### [1531. 483. ]
> ting to, matters set forth on the Schedules or in the Filed `SEC` Documents; or \(xv\) \(A\) the commencement or pendency of the

#### [1531. 482. ]
> xiv\) the matters set forth on the Schedules or in the Filed `SEC` Documents and any changes or developments in, or 
> 
> Effects o

#### [1531. 481. ]
> uding any matter set forth in the Schedules or in the Filed `SEC` Documents; \(x\) Effects in, arising from or relating to any

#### [1531. 480. ]
> nt publicly available on the SECs EDGAR database \(the Filed `SEC` Documents\) \(other than any disclosures set forth under the

#### [1531. 479. ]
> es, statements, exhibits and other documents filed with the `SEC` by BBBY in respect of Sellers and their business to the ext
...
#### [1498. 474. (OCR img_0118)]
> ctiomLot Township/Block Range/ Tract 32 2N IE N2 W2 SW4 SE4 `SEC` 32 A complete legal description is available Irom the Maric

#### [1498. 473. (OCR img_0115)]
> ectionLot Township/Block RangelTract 32 2N IE S2 W2 SW4 SE4 `SEC` 32 EX S 60F A complele Iegal descriplion is available the M

### Docket 1498

#### [1498. 472. (OCR img_0112)]
> TH N \(36F TH E 178F TH \$ 136F TO POB & EX PT DAF COM SE COR `SEC` TH N 1290.2SF TH \$ 88D 4BM W 4SF TO POB TH CONT S 88D 48M W

#### [1498. 471. (OCR img_0112)]
> 0F OF E 94F THIOF & EX EX BEG AT PT 33F N & 94F W OF SE COR `SEC` TH W \[78F TH N \(36F TH E 178F TH \$ 136F TO POB & EX PT DAF
...
#### [1291. 398. (OCR img_0002)]
> EF3HRAS/ LANn FXCIERACICN\! EXONEKATION SEGURO SUCIAL SOCIAL `SEC` JR BANCO \! BANK NUMERI\) ME PRESTAMO / LOAN NJM3FA 536,019 E

### Docket 1291

#### [1291. 397. (OCR img_0000)]
> EF3HRAS/ LANn FXCIERACICN\! EXONEKATION SEGURO SUCIAL SOCIAL `SEC` JR BANCO \! BANK NUMERI\) ME PRESTAMO / LOAN NJM3FA 536,019 E
...
#### [1210. 380. ]
>  MATTERS CLAIM REVIEW 
> 
>  05/31/23 JMD EMAIL TO R. JARECK RE: `SEC` FILING MATTERS 0.20 80.00 
> 
>  
> 
>  REAL ESTATE 38.50 31,122.00 
> 


#### [1210. 379. ]
> NVESTIGATION ACTION ITEMS 0.20 160.00 
> 
>  05/31/23 JMD REVIEW `SEC` FILINGS IN CONNECTION WITH INTERNAL 2.30 920.00 
> 
> INVESTIGAT
...
> 
>  05/26/23 MDS REVIEW DISCOVERY AND DEP
...
> Lindsey Beran
> 
> 0.60 Review, analyze findings re `SEC` filings chronology project \(.2\); correspond with J. Kennedy

#### [1209. 376. ]
> . Lullo, K&E team re same \(.3\); review, revise summaries re `SEC` filings and proxy statements \(.6\).
> 
> 05/19/23
> 
> Janet Bustamant
...
#### [1209. 375. ]
> \); review, analyze document summaries \(.2\); review, analyze `SEC` statements re claims investigation \(.3\).
> 
> 1.80 Conference wi

#### [1209. 374. ]
> ements review \(.5\); correspond with J. Kennedy re review of `SEC` materials \(.4\); correspond with J. Kasulis re status of doc

#### [1209. 373. ]
> Lullo re outstanding assignments re board materials review, `SEC`, public statements review \(.5\); correspond with J. Kennedy

#### [1209. 372. ]
> \(1.5\); correspond with B. Yantren re same \(.3\).
> 
> 2.60 Review `SEC` filings re claims investigation \(1.6\); conduct scoping inte

#### [1209. 371. ]
> n, S. Cohen re open litigation issues.
> 
> 5.20 Review, analyze `SEC` filings re share programs \(3.9\); research re same \(1.3\).
> 
> 1.

#### [1209. 370. ]
> respond with J. Kasulis re SEC chronology \(.1\).
> 
> 0.90 Review `SEC` filings chronology \(.6\); correspond with J. Bustamante re d

#### [1209. 369. ]
> purchase authorizations \(.4\); correspond with J. Kasulis re `SEC` chronology \(.1\).
> 
> 0.90 Review SEC filings chronology \(.6\); c

#### [1209. 368. ]
> pany re same \(.1\).
> 
> 0.70 Review, analyze L. Beran summary re `SEC` chronology, claims investigation follow-up \(.2\); correspond

#### [1209. 367. ]
> n re company background \(.7\); review, analyze chronology of `SEC` filing statements re claims investigation \(.6\).
> 
> 1.30 Draft

#### [1209. 366. ]
> nvestigation, next steps \(.2\); review responsive documents, `SEC` filings re company chronology \(1.0\); correspond with A. Lul

#### [1209. 365. ]
>  SEC filings re claims investigation \(.3\); draft summary of `SEC` filings \(.3\); correspond with L. Beran re same \(.2\).
> 
> 0.70 A

#### [1209. 364. ]
> laims investigation coordination \(.5\).
> 
> 0.80 Review, analyze `SEC` filings re claims investigation \(.3\); draft summary of SEC
...
> \(.3\).
> 
>  05/02/23 Jackson Kennedy 3.70 Review, analyze `SEC` filings re claims 
> 
> investigation.
> 
>  05/02/23 Allison Lullo 0

#### [1209. 362. ]
> gation \(.3\).
> 
>  05/01/23 Jackson Kennedy 2.70 Review, analyze `SEC` filings re claims 
> 
> investigations \(2.0\); draft summary re s

#### [1209. 361. ]
> revise and draft same \(.6\).
> 
> 0.50 Conference with Company re `SEC` filings.
> 
> 0.50 Correspond with company advisors re transacti

#### [1209. 360. ]
>  status.
> 
> 0.30 Review and analyze 10-K.
> 
> 0.70 Review, analyze `SEC` filings re audit report \(.3\); draft analysis re same \(.3\);

#### [1209. 359. ]
> O. Nagler, P.C. 0.50 Participate in telephone conference re `SEC` 
> 
> reporting obligations.
> 
>  05/02/23 Mary Catherine Young 0.40
...
> ated items
> 
>  Chung, Angelina 5/11/2023 1.0 Review historical `SEC` filings re: tax reporting
> 
>  Hyak, Tim 5/11/2023 1.9 Conduct
...
> 0.2
> 
> Correspond with UCC member re: `SEC` filings
> 
> of 28
> 
> Professional
...
> 0.6
> 
> Review `SEC` filings re: debt repayments
> 
> Desai, Bijal
> 
> 5/23/2023
...
> 0.5
> 
> Review `SEC` filings re: applicable FILO facility fees
> 
> Desai, Bijal
> 
> 5/19
...
#### [1008. 293. (OCR img_0001)]
> New York corporation, Tenant ARROWHEADPALMS SHOPPING CENTER `SEC` 75th Avenue & Bell Road PEORIA, ARIZONA Dated as of: Februa

### Docket 1008

#### [1008. 292. (OCR img_0000)]
> New York corporation, Tenant ARROWHEADPALMS SHOPPING CENTER `SEC` 75th Avenue & Bell Road PEORIA, ARIZONA Dated as of: Februa
...
> r, P.C.
> 
> 1.20 Analyze 12b-25 \(.7\); telephone conference with `SEC` re 10-K filing \(.3\); correspond with Company re preferred s

#### [956. 286. ]
> n O. Nagler, P.C.
> 
> 1.50 Attend telephone conferences with re `SEC` filings.
> 
> 04/25/23
> 
> Josh Sussberg, P.C.
> 
> 0.30 Telephone confer

#### [956. 285. ]
> . Nagler, P.C. 0.40 Correspond with D. Hunter, K&E team re 
> 
> `SEC` status and filings.
> 
>  04/24/23 Noah Z. Sosnick 0.80 Revise b

#### [956. 284. ]
> ase of office space at Trial location, IT equipment rental, `SEC` and regulatory filings, etc.\) incurred on behalf of a clien

#### [954. 283. (OCR img_1440)]
> `SEC`. 3- DEFTNTTTONS \(e\) DEFINITION QF CERTAN FOODS As DIETARY S

### Docket 954

#### [954. 282. (OCR img_0145)]
> `SEC`. 3- DEFTNTTTONS \(e\) DEFINITION QF CERTAN FOODS As DIETARY S
...
#### [889. 260. ]
> dvice and guidance relative to the Debtors’ compliance with `SEC` reporting requirements and the related financials statement
...
> • Footnote Support 
> 
> Assist the Debtors with year-end `SEC` reporting including drafting and preparation of the footnot

#### [889. 258. ]
>  \(“U.S. GAAP”\) and U.S. Securities and Exchange Commission \(`SEC`\) rules and regulations, and/or \(3\) other accounting and int
...
> RY, 100 F. STREET NE, 
> 
> WASHINGTON, DC, 20549, SECBANKRUPTCY@`SEC`.GOV
> 
> Electronic
> 
> 9273
> 
> SEWARD & KISSEL LLP, ATTN: ROBERT J. GA

#### [740. 224. ]
> 7 JFK BLVD, STE 520, PHILADELPHIA, PA, 19103, SECBANKRUPTCY@`SEC`.GOV
> 
> Electronic
> 
> 9273
> 
> SECURITIES AND EXCHANGE COMMISSION, ATT

#### [740. 223. ]
>  
> 
> STREET, STE 400, NEW YORK, NY, 10281-1022, NYROBANKRUPTCY@`SEC`.GOV
> 
> Electronic
> 
> 9273
> 
> SECURITIES & EXCHANGE COMMISSION - PHIL

#### [740. 222. ]
> ET, STE 400, NEW YORK, NY, 10281-1022, BANKRUPTCYNOTICESCHR@`SEC`.GOV
> 
> Electronic
> 
> 9273
> 
> SECURITIES & EXCHANGE COMMISSION - NY O
...
#### [716. 213. ]
> ocuments are included in materials otherwise filed with the `SEC`\) may be delivered electronically and, if so delivered, shal

#### [716. 212. ]
>  Authority succeeding to any or all of the functions of the `SEC`, or with any national securities exchange, or distributed b

#### [716. 211. ]
> aterials filed by any Loan Party or any Subsidiary with the `SEC`, or any Governmental Authority succeeding to any or all of

#### [716. 210. ]
> ntrol Laws or \(d\) any other relevant sanctions authority. 
> 
...
#### [716. 209. ]
> market funds that \(i\) comply with the criteria set forth in `SEC` Rule 2a-7 under the Investment Company Act of 1940, \(ii\) ar

### Docket 714

#### [714. 208. ]
> ath & Beyond Inc. Kimco Riverview, L.L.C. Lease Agreement - `SEC` Dobson Road & Loop 202, Mesa, AZ 313.65
> 
> Bed Bath & Beyond I
...
> 829P3-1401 ROUTE 300 HOLDINGS LLC 
> 
> GMAC MTG `SEC` INCMTG PT CT SERIES 2006-C1REMIC I
> 
> P.O. BOX 785191
> 
> PHILADEL
...
> JIA WEI LIFESTYLE INC. 
> 
> 14F‐4 NO296 `SEC` 4 XINYI ROAD DA'AN DIST
> 
> TAIPEI
> 
> 10679
...
> 12749148
> 
> FLABEG TECHNICAL GLASS US COR

#### [604. 150. ]
> RGIA INVESTEMENT HOLDING 
> 
> LIMITED
> 
> 3F NO. 2‐8 ALY 12 LN. 143
> 
> `SEC` 2 ZHONGZHENG E. RD
> 
> TAMSUI DIST.
> 
> NEW TAIPEI CITY
...
> CROWN KING ENT. LTD. 
> 
> 2ND FLOOR NO 51 LANE 629 NEI‐HU ROAD `SEC` 1
> 
> TAIPEI
> 
> TAIWAN
...
> BEAR STEARNS COMM MTG `SEC`, INC 
> 
> 311 PARK PL BLVD, SUITE 600
> 
> COMM MTG P/T CERT2005‐PWR
...
> P.O. BOX 785191
> 
> PT CT SERIES 2006‐C1 REMIC IGMAC 
> 
> MTG `SEC` INC
> 
> MTG214635
...
> 12765228
> 
> 1010P2‐BEAR STERNS COMM. MTG `SEC`, INC. 
> 
> COMM MTG P/T CERT 2005‐PWR10RI
> 
> C/O COLLIERS INTERNAT
...
> Email
> 
> COUNSEL TO SHARKNINJA OPERATING LLC 
> 
> SHARKNINJA O
...
> t mail
> 
> LC\_011789 829P3-1401 ROUTE 300 HOLDINGS LLC
> 
> GMAC MTG `SEC` INCMTG PT CT SERIES 2006-C1REMIC I 
> 
> P.O. BOX 785191 
...
#### [154. 74. ]
> ch trades is in violation of Section 16\(b\) and rules of the `SEC` promulgated thereunder. 
> 
> Under Section 16\(b\), profits earne

#### [154. 73. ]
>  security sold for a period not exceeding six months. 
> 
>  
> 
> 17
> 
> `SEC` Rule 16a-1\(a\), 17 C.F.R. §240.16a-1\(a\), deems a “beneficial

#### [154. 72. ]
> Cohen filed his submission via paper and not via EDGAR, the `SEC`’s electronic filing system, which delayed the public releas

#### [154. 71. ]
>  24, 2022, BBB and Cohen both filed public reports with the `SEC` announcing that they entered into the CA whereby BBB permit

#### [154. 70. ]
> d by highly experienced attorneys, fail to make very simple `SEC` filings to disclose their 10% ownership position as soon as

#### [154. 69. ]
> affirmatively engage in any transactions. For instance, the `SEC` has explained that “\[f\]ollowing a company’s buyback of its

#### [154. 68. ]
> s and must file statements reporting their ownership to the `SEC` by filing initial statements of beneficial ownership of equ

#### [154. 67. ]
> may rely upon the issuer’s latest share count in its latest `SEC` filing. Accordingly, even if a filer does not “believe” he/

#### [154. 66. ]
>  10 days of the acquisition of the 5%, a statement with the `SEC` containing the information required by Schedule 13D. This s

#### [154. 65. ]
> ection 13\(d\)\(1\) of the Exchange Act \(15 U.S.C. §78m\(d\)\) and `SEC` Rule 13d-1 \(17 C.F.R. §240.13d-1\) require any person who ha

#### [154. 64. ]
> the Board and knew the balance remaining as of the last BBB `SEC` filing with an outstanding share count. Defendants also kne

#### [154. 63. ]
>  BBB securities on January 13, 2022. According to their own `SEC` filings and based on publicly available data and admission

#### [137. 62. (OCR img_0093)]
> spute 4 Express Representations 18 Agreement Order 22 Filed `SEC` Documents \_ 10 Allocation. 42 Foreign Competition Laws 11 A

#### [137. 61. (OCR img_0091)]
> ting to, matters set forth on the Schedules or in the Filed `SEC` Documents; or \(xv\) \(A\) the commencement or pendency of the

#### [137. 60. (OCR img_0091)]
> xiv\) the matters set forth on the Schedules or in the Filed `SEC` Documents and any changes or developments in, or Effects or

#### [137. 59. (OCR img_0090)]
> uding any matter set forth in the Schedules or in the Filed `SEC` Documents; \(x\) Effects in, arising from Or relating to any

#### [137. 58. (OCR img_0063)]
> actions, and Director Independence" disclosure in the Filed `SEC` Documents, to the Knowledge of Sellers, no Affiliate of any

#### [137. 57. (OCR img_0057)]
>  publicly available on the SEC's EDGAR database \(the 'Filed `SEC` Documents"\) \(other than any disclosures set forth under the

#### [137. 56. (OCR img_0057)]
>  and their business to the extent publicly available on the `SEC`'s EDGAR database \(the 'Filed SEC Documents"\) \(other than an
...
#### [129. 41. ]
> By:/s/ Sheppard A. Guryan 
> 
> SHEPPARD A. GURYAN, ESQ.
> 
> P:\\Docs\\`SEC`\\RLZ\\BANKR DOCS\\Bed Bath & Beyond\\Pleadings\\Notice of Appear
...
#### [92. 28. ]
> press Representations ........................... 18 
> 
> Filed `SEC` Documents ............................... 10 Foreign Compet
